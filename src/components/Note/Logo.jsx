        ...
        <div className={styles.items1}>
          <div className={styles.item} style={{ height: "" }}>
            ...
            <div className=" text-white w-[50%] m-2 px-3">
              ...
              id mollitia quas eos, voluptas nihil. Officia quisquam ab velit
              amet molestias vitae necessitatibus a sequi aut quod voluptatibus
              ex numquam laborum, alias ducimus itaque, fuga consequuntur
              suscipit magnam tenetur adipisci temporibus recusandae harum quos.
              Quasi libero temporibus ad beatae? Pariatur eligendi vitae optio
